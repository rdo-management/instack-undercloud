...
#. Build the required images:
 ...
 .. note ::
    By default, images are built with the latest RDO-Manager Trunk repo which has passed CI. If we need to manually test packages before CI has passed, we can use:
