...
You can enable this feature by setting DISCOVERY_RUNBENCH=1 in the
...
DISCOVERY_RUNBENCH=1 in undercloud.conf, and re-run `openstack undercloud install`.
