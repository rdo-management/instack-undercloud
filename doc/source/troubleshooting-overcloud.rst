...
* Failed Nova Server ResourceGroup Deployments
  ...
  The ironic logs are also useful, those are accessed via journalctl::

    $ sudo journalctl -u openstack-ironic-conductor -u openstack-ironic-api --full
