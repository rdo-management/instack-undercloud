...
* Open the /etc/edeploy/control.specs file. By default it will look close to this
  ...
  * For example if we had a "fact" from discovery:
  ...
  .. note :: More information on creating spec files can be found in the `edeploy documentation`_.
...
.. _`edeploy documentation`: https://github.com/enovance/edeploy/blob/master/docs/eDeployUserGuide.rst#spec-file
