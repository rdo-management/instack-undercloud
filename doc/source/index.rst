...
On these sites we are going to explain what is `RDO-Manager <introduction/
introduction.html>`_ and guide you through its setup and how to use it to
successfuly deploy `RDO <http://rdoproject.org>`_ (OpenStack packaged for
Fedora, Centos and RHEL distributions).
