...
openstack services. It wraps openstack clients like glance, nova, etc.
The main value is that all services can be controlled by single (openstack)
...
installation and initial configuration like nodes discovery, overcloud image
